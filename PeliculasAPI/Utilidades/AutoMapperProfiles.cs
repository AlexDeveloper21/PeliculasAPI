    ...
    public class AutoMapperProfiles : Profile
    {
        ...
        private void ConfigurarMapeoPeliculas()
        {
            CreateMap<PeliculaCreacionDTO, Pelicula>()
                ...
                dto => dto.MapFrom(p =>  p.GenerosIds!.Select(id => new PeliculaGenero { GeneroId = id })))
                .ForMember(x => x.PeliculasCines,
                dto => dto.MapFrom(p => p.CinesIds!.Select(id => new PeliculaCine { CineId = id })))
                .ForMember(x => x.PeliculasActores,
                dto => dto.MapFrom(p => p.Actores!.Select(actor => new PeliculaActor { ActorId = actor.Id, Personaje = actor.Personaje })));
        ...
        public void ConfigurarMapeoCines(GeometryFactory geometryFactory)
        {
